...
//Add Product
		public function add($product){
			$dbh = new PDO("mysql:host=localhost;dbname=members_reserve","root","");
			$req = "INSERT INTO `member`(`id`,`Firstname`, `Lastname`,`phone`) VALUES (:id,:Firstname,:Lastname,:phone)";
            ...
            $updateProductQuery -> bindParam(":phone",$product->getMatricule(),PDO::PARAM_STR);
		...
		public function update($product){
			$id = $product->getId();
			$dbh = new PDO("mysql:host=localhost;dbname=members_reserve","root","");
			$req = "UPDATE member SET Firstname = :Firstname,Lastname = :Lastname,phone = :phone WHERE id = $id";
			$updateProductQuery = $dbh ->prepare($req);
			$updateProductQuery -> bindParam(":Firstname",$product->getName(),PDO::PARAM_STR);
            $updateProductQuery -> bindParam(":Lastname",$product->getLast(),PDO::PARAM_STR);
            $updateProductQuery -> bindParam(":phone",$product->getMatricule(),PDO::PARAM_STR);
